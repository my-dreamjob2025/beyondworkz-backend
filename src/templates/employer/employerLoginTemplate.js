...
<html lang="en">
  <head>
    ...
    <title>Employer Login OTP</title>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;background-color:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.05)">
      ...
      <tr>
        <td style="padding:0 24px 24px;">
          ...
          <p style="color:#1e293b;font-size:16px;margin:0 0 8px;">Hi ${safeName || "Employer"},</p>
          <p style="color:#475569;font-size:14px;margin:0 0 20px;">Use the code below to log in to your Beyond Workz Employer account.</p>
