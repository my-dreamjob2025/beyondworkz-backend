    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;background-color:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.05)">
      ...
      <tr>
        <td style="padding:0 24px 24px;">
          <h3 style="color:#1e293b;font-size:18px;margin:0 0 4px;font-weight:400">YOU'RE ONE STEP AWAY</h3>
          <h2 style="color:#1e293b;font-size:26px;margin:0 0 16px;font-weight:700">Use this 6-digit OTP</h2>
          <p style="color:#1e293b;font-size:16px;margin:0 0 8px;">Hi ${safeName || "there"},</p>
          <p style="color:#475569;font-size:14px;margin:0 0 20px;">You're almost done creating your account at Beyond Workz.</p>
          ...
          <p style="color:#475569;font-size:14px;margin:0;">Didn't ask for this? You can safely ignore this email.</p>
        </td>
      </tr>
      <tr>
